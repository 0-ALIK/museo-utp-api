...
const { facultades, carreras, auth, visitantes, usuarios, articulos, comentarios, categorias, participantes } = require('../routes');
...
class Server {
    ...
    rutas() {
        ...
        this.app.use( this.paths.participantes, participantes );
    }
